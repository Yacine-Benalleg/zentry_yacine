...
const Features = () => {
  '';
  return (
    <section className="bg-black pb-32 max-w-full px-2">
      <div className="container mx-auto px-3 md:px-10 max-w-[100vw]">
        ...
        box-border overflow-hidden rounded-md md:h-[65vh] "
        >
          <BentoCard
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3">
          <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
            <BentoCard
              ...
              description="An anime and gaming-inspired
          ...
          <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
            <BentoCard
              ...
              your gameplay to be more fun and productivie."
            />
          </BentoTilt>
